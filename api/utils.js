...
export const getUserByIdUtil = (protocol, host, port, id) => {
...
export const updateUserByIdUtil = (protocol, host, port, payload, id) => {
...
export const deleteUserByIdUtil = (protocol, host, port, id) => {
